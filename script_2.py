# Fix the indentation error and create the enhanced code properly
    ...
    with st.container():
        ...
        if st.session_state.join_conditions:
            ...
            for i, join in enumerate(st.session_state.join_conditions):
                ...
                """
                st.markdown(join_html, unsafe_allow_html=True)
...
print(f"📄 File saved as: enhanced_nlp_sql_app.py")
